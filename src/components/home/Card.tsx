...
const Card = () => {
    return (
        <div className="mt-16 lg:mx-36 grid md:gap-0 md:grid-cols-3 md:grid-rows-1 border-muted border-2 p-6 rounded-lg grid-cols-1 grid-rows-3 gap-12 mx-6 shadow-sm shadow-muted">
            {perks.map((perk) => (
